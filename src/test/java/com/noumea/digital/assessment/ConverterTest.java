...
public class ConverterTest {
    ...
    public void testPrnToJson() throws IOException {
        ...
        String workbook = convertPrnFileToJson(PRN_CONTENT, DECIMAL_COL_INDEXES, DATE_COL_INDEXES, CHUNK_SIZES);
        assertEquals(workbook, fileContent);
    }
    ...
    public void testPrnToHtml() throws IOException {
        ...
        String workbook = convertPrnFileToHtml(PRN_CONTENT, DECIMAL_COL_INDEXES, DATE_COL_INDEXES, CHUNK_SIZES);
        assertEquals(workbook, fileContent);
    }
    ...
    public void compareJson() {
        ...
        String workbook2 = convertPrnFileToJson(PRN_CONTENT, DECIMAL_COL_INDEXES, DATE_COL_INDEXES, CHUNK_SIZES);
    ...
    public void compareHtml() {
        ...
        String workbook2 = convertPrnFileToHtml(PRN_CONTENT, DECIMAL_COL_INDEXES, DATE_COL_INDEXES, CHUNK_SIZES);
        assertEquals(workbook1, workbook2);
    }
